...
**3.3本协议的构成。** 由于互联网行业高速发展，您与我们签署的本协议列明的条款并不能完整罗列并覆盖您与我们所有权利与义务，现有的约定也不能保证完全符合未来发展的需求。因此，昶元公司通过设立《[Omnibox产品隐私政策](/single/privacy-policy)》、单独规则（统称“Omnibox产品规则”）以进行补充规定和完善，前述内容均为本协议的有效组成部分，与本协议不可分割且具有同等法律效力。如您使用Omnibox或相关服务，视为您同意上述全部协议。
