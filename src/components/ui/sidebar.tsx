      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          <SheetContent
            ...
            data-mobile="true"
            className="touch-none-select w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
            ...
            side={side}
          >
            <div className="touch-none-select flex size-full flex-col pt-[env(safe-area-inset-top)]">
              {children}
            </div>
          </SheetContent>
        </Sheet>
