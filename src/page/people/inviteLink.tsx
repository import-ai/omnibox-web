...
import { useSettingsToast } from '@/page/settings/settingsToast';

import { AddNamespaceInvitationForm } from './addForm';
    ...
    <>
      ...
      <div className="mb-4 flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="mt-2 flex items-center gap-2 lg:mt-0">
          {!!invitationId && (
            <span
              className="cursor-pointer text-xs text-neutral-400 hover:text-foreground lg:text-sm"
              onClick={handleCopy}
            >
              {t('actions.copy_link')}
            </span>
