...
export default function Wechat() {
  ...
  //     try {
  //       const response = await fetch(`/auth/wechat/check/${currentState}`);
  ...
  //   http.get('/auth/wechat/qrcode').then((response) => {
  //     //  state,
  //     // qrcode,
  //     // expiresIn,
  //     startCheckingStatus();
  ...
  //   http.get('/auth/wechat/auth-url').then((authUrl) => {
