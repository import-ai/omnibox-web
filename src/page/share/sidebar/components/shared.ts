...
export const smartFolderSelectTriggerClass =
  'h-9 w-full rounded-md border-line bg-transparent px-3 text-sm text-foreground shadow-none hover:bg-transparent focus:ring-0 focus:ring-transparent focus:outline-none';
