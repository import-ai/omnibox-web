...
// Root-loading states. Kept in their own file rather than merged into
// WorkspaceResourcePicker.test.tsx: the two suites stub `@/service/resource`
// and `./workspaceResourcePickerSort` differently, and jest module mocks are
// file-scoped.
describe('WorkspaceResourcePicker roots', () => {
