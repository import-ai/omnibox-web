...
## Git Commit & Code Review Guidelines

When creating commits or reviewing code, do NOT include:

- "Generated with Claude Code" or similar attribution lines
- "Co-Authored-By: Claude" or any Claude co-author tags

Keep commit messages and review comments clean and focused on the changes only.
