...
ARG VITE_CHAT_HOME_DEFAULT_INPUT_ZH
ARG VITE_CHAT_HOME_DEFAULT_INPUT_EN
ENV VITE_CHAT_HOME_DEFAULT_INPUT_ZH=$VITE_CHAT_HOME_DEFAULT_INPUT_ZH
ENV VITE_CHAT_HOME_DEFAULT_INPUT_EN=$VITE_CHAT_HOME_DEFAULT_INPUT_EN
